      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
        ...
        <div className="p-6 space-y-4">
          <form onSubmit={handleAddCategory} className="flex gap-2">
            ...
            />
            <button type="submit" disabled={isSubmitting} className="px-4 py-2 bg-purple-600 text-white rounded-md flex items-center gap-2 disabled:opacity-50">
                ...
                {editingCategory?.id === cat.id ? (
                  <div className="flex-grow flex items-center gap-2">
                    <input 
                      ...
                      className="flex-grow px-2 py-1 border border-purple-400 rounded-md"
                      autoFocus
                    />
                  ...
                  <>
                    ...
                    <div className="flex items-center gap-3">
                      <button onClick={() => handleEditClick(cat)} className="text-gray-400 hover:text-purple-600"><Edit size={16} /></button>
